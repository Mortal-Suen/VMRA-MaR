import os
from vmramar.datasets.factory import RegisterDataset
from vmramar.datasets.abstract_onco_dataset import Abstract_Onco_Dataset
from vmramar.utils.region_annotation import parse_region_annotations, get_region_annotation_for_path
import vmramar.utils
import tqdm
...
class MGH_Mammo_Patch_Risk_Dataset(Abstract_Onco_Dataset):
    ...
    def create_dataset(self, split_group, img_dir):
        ...
        class_balance = vmramar.utils.generic.normalize_dictionary(class_balance)
        print(
