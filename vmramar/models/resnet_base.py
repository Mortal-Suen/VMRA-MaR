...
import pdb
import numpy as np
from vmramar.models.pools.factory import get_pool
from vmramar.models.spatial_transformers.factory import get_spatial_transformer
from vmramar.models.cumulative_probability_layer import Cumulative_Probability_Layer


class ResNet(nn.Module):
    """
        A ResNet model. Blocks can be Basic, Non-local, bottleneck or
        anything in vmramar.models.blocks and intermixed in any order.
